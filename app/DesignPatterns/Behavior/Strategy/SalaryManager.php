<?php
namespace App\DesignPatterns\Behavior\Strategy;
...
class SalaryManager
{
    ...
    private function saveSalary(Collection $users)
    {
        return true;
    }
    private function getStrategyByUser(User $user): SalaryStrategyInterface
    {
        ...
        throe_if(!class_exists($strategyClass), \Exception::class, 'Class not found [{$strategyClass}]');
